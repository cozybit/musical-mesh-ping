...
public class ChordService extends Service {
    ...
    public static String CHORD_APITEST_CHANNEL = "BACON_CHANNEL";

    private static final String TAG = "[MeshPing]";
    ...
    public interface IChordServiceListener {
        void onReceiveMessage(String node, String channel, String dataType, String message);
    ...
    public int start(int interfaceType) {
        ...
        return mChord.start(interfaceType, new IChordManagerListener() {
            ...
            public void onStarted(String name, int reason) {
                ...
                if (null != mListener)
                    mListener.onNodeEvent(null, ChordManager.PUBLIC_CHANNEL, true);
    ...
    public boolean sendData(String toChannel, String nodeName, String dataType, byte[] buf) {
        if (mChord == null) {
         ...
         * is returned
         */
        if (false == channel.sendData(nodeName, dataType, payload)) {
